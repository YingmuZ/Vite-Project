      ...
      <div className="w-full h-screen absolute top-0 left-0 bg-white/50">
        <div className="max-w-[700px] m-auto h-full -w-full flex flex-col justify-center lg:items-start items-center">
          ...
          <div className="flex lg:items-start justify-between  gap-5 pt-4 max-w-[100px] w-full">
            <a
              href="https://www.linkedin.com/in/yingmu-zhang-421b94212/"
              target="_blank"
            >
              <FaLinkedinIn className="cursor-pointer" size={25} />
            </a>
            <a href="https://github.com/YingmuZ" target="_blank">
              <FaGithub className="cursor-pointer inline-block" size={25} />
            </a>
          </div>
        </div>
      </div>
